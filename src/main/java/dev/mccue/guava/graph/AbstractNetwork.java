...
import static dev.mccue.guava.graph.GraphConstants.EDGE_REMOVED_FROM_GRAPH;
import static dev.mccue.guava.graph.GraphConstants.ENDPOINTS_MISMATCH;
import static dev.mccue.guava.graph.GraphConstants.MULTIPLE_EDGES_CONNECTING;
import static dev.mccue.guava.graph.GraphConstants.NODE_PAIR_REMOVED_FROM_GRAPH;
import static dev.mccue.guava.graph.GraphConstants.NODE_REMOVED_FROM_GRAPH;
...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
  ...
  /**
   * Returns a {@code Set} whose methods throw {@code IllegalStateException} when the given edge is
  ...
  /**
   * Returns a {@code Set} whose methods throw {@code IllegalStateException} when the given node is
   * not present in this network.
   *
   * @since 33.1.0
   */
  ...
  /**
   * Returns a {@code Set} whose methods throw {@code IllegalStateException} when either of the
