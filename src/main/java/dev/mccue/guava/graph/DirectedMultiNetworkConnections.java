...
import static dev.mccue.guava.graph.GraphConstants.INNER_CAPACITY;
import static dev.mccue.guava.graph.GraphConstants.INNER_LOAD_FACTOR;

import dev.mccue.guava.collect.HashMultiset;
...
/**
 * An implementation of {@code NetworkConnections} for directed networks with parallel edges.
 *
 * @author James Sexton
